...
{   
    public interface IRepository<T> : IDisposable where T : class
    {
        ...
        /// /// <returns></returns>
        Task<T> Add(T entity, bool isSave = true);
        ...
        /// <param name="isSave">是否执行</param>
        Task<int> AddRange(IEnumerable<T> entitys, bool isSave = true);
        ...
        /// <param name="entity">实体对象</param>
        /// <param name="isSave">是否执行</param>
        Task<int> Delete(T entity, bool isSave = true);
        ...
        /// <param name="entitys">实体对象集合</param>
        /// <param name="isSave">是否执行</param>
        Task<int> Delete(bool isSave = false, params T[] entitys);
        ...
        /// <param name="isSave">是否执行</param>
        Task Delete(Expression<Func<T, bool>> @where, bool isSave = true);
        ...
        /// <param name="entitys">实体对象集合</param>
        /// <param name="isSave"></param>
        Task Update(bool isSave = true, params T[] entitys);
